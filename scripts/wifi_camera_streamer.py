...
class IPCamera():
    def __init__(self):
        ...
        self.bytes=''
        self.image_pub = rospy.Publisher("camera_image", Image, queue_size=100)
...
if __name__ == '__main__':
    ...
    folder = rospy.get_param('~folder', '/home/santos/wifiCam/')
    ip_camera = IPCamera()
    ...
    while not rospy.is_shutdown():
        ...
        if a!=-1 and b!=-1:
            ...
            image_message = np.asarray(cv.fromarray(i))
            #width, height = cv.GetSize(cv.fromarray(i))
            #print width
            #print height
            ...
            filename = folder + 'cam_'+ current_time + '.jpg'
